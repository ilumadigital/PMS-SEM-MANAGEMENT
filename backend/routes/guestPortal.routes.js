...
const managementAccess = [protect, restrictTo('admin', 'manager', 'management', 'reception', 'supervisor')];
const adminAccess = [protect, restrictTo('admin', 'manager', 'management')];

router.post(
    '/reservations/:reservationId/send-instructions',
    protect,
    restrictTo('admin', 'manager', 'management', 'reception'),
