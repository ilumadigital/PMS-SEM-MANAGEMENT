...
router.get('/housekeeping', protect, restrictTo('admin','manager','management','reception','supervisor','cleaneradmin','cleaner','cleaning'), operationsController.getHousekeepingStatus);
