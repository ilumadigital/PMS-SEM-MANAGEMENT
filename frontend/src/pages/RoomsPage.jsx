...
const RoomsPage = () => {
  ...
  return <div className="space-y-6">
    <PageHeader title="Rooms" description="Cloudbeds room inventory with SEM PMS housekeeping state. Only Clean / Dirty / Inspected sync back to Cloudbeds; other PMS operational fields remain local." actions={<button onClick={status?.connected?refresh:connect} className="rounded-lg bg-blue-600 px-3.5 py-2 text-sm font-semibold text-white hover:bg-blue-700">{status?.connected?'Refresh Cloudbeds':'Connect Cloudbeds'}</button>} />
