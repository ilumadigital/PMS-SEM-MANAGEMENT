...
const SupervisorPanel = () => {
  ...
  return <div className="space-y-6">
    <PageHeader title="Supervisor" description="One control surface for housekeeping readiness, priority rooms and active transfers." actions={<button onClick={load} className="rounded-lg bg-blue-600 px-3.5 py-2 text-sm font-semibold text-white hover:bg-blue-700">Refresh operations</button>} />
    ...
    <div className="grid grid-cols-2 gap-4 xl:grid-cols-4">
      ...
      <MetricCard label="Active transfers" value={transfers.length} tone="blue" />
    </div>
