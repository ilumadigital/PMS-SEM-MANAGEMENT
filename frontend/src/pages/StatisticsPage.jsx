...
const StatisticsPage = () => {
  ...
  const exportCsv = () => {
    const lines = [['Metric','Value'],['Reservations',inRangeReservations.length],['Transfers',transferTotal],['Completed transfers',completedTransfers],['Cleaning tasks',cleaningTotal],['Completed cleaning',completedCleaning],['Properties',properties.length]];
  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-5 xl:grid-cols-2">
      <Panel title="Transfer performance" description="Counts by operational status for the selected date range."><StatusTable rows={ops.transfers} /></Panel>
